...
import com.project.my_store.requests.Login;
import com.project.my_store.response.ApiResponse;
import com.project.my_store.response.JwtResponse;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<ApiResponse> login(@Valid @RequestBody Login request){
        try {
